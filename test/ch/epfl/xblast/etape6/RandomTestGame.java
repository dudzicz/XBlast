        ...
        while (!s.isGameOver()) {
            ...
            for(Player p: s.players()) {
                ...
                for(List<Integer> e: pos) {
                	...
                	if(h.direction().ordinal() != e.get(2) || h.position().x() != e.get(0) || h.position().y() != e.get(1)){
                	    System.out.println("Ticks" + s.ticks());
                	    System.out.println(p.id());
                	    System.out.println("Is Central ? " + h.position().isCentral());
                	    System.out.println("Distance to central " + h.position().distanceToCentral());
                	    System.out.println(e.get(2)+ " actual " + h.direction().ordinal());
                	}
